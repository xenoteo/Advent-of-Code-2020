 ...
 * Running seats rearrangements according to required rules. All decisions are based on the number
 * of the first seats seen in each of eight directions.
 * The following rules are applied to every seat simultaneously:
 *  - If a seat is empty (L) and there are no visible occupied seats, the seat becomes occupied.
 *  - If a seat is occupied (#) and there are five or more visible occupied seats, the seat becomes empty.
