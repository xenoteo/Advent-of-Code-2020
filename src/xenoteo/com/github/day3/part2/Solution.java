 ...
 *  - right 1, down 2
 *
 * Counting how many trees can be encountered starting at the top-left corner of the map and following given slopes,
...
public class Solution {
    ...
    /**
     * Getting a list of slopes (one slope is a list of 2 elements,
     * where the first represents rightStep and the second represents downStep), counting trees on all the ways
